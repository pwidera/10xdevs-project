...
export async function post<T = unknown>(url: string, body: unknown, init: RequestInit = {}): Promise<ApiResponse<T>> {
...
export async function del<T = unknown>(url: string, init: RequestInit = {}): Promise<ApiResponse<T>> {
