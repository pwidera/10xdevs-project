 ...
 * Derived from: Tables<'flashcards'>
 */
export type StudyFlashcardDTO = Pick<Tables<"flashcards">, "id" | "front_text" | "back_text" | "last_reviewed_at">;
 ...
 */
export type CreateFlashcardCommand = Pick<TablesInsert<"flashcards">, "front_text" | "back_text"> &
  Partial<Pick<TablesInsert<"flashcards">, "origin" | "generation_session_id">>;
 ...
 */
export type UpdateFlashcardCommand = Partial<Pick<TablesUpdate<"flashcards">, "front_text" | "back_text">>;
 ...
 */
export interface GenerationSessionsListQuery {
  page?: number; // default 1
 ...
 */
export interface AcceptProposalsCommand {
 ...
 */
export interface StudyBatchQuery {
 ...
 */
export interface MarkReviewedCommand {
